...
The Apple location-based services provides data on three types of mobility indices (walking, driving, and transit), which are summarized in `data/travel_data/us_domestic/apple_mobility_indices.csv`; these records are based on user direction requests in Apple Maps.
